...
import io.github.atimothee.rocketsolution.provider.base.BaseContentProvider;
import io.github.atimothee.rocketsolution.provider.product.ProductColumns;

public class RocketProvider extends BaseContentProvider {
    private static final String TAG = RocketProvider.class.getSimpleName();
    ...
    public static final String AUTHORITY = "io.github.atimothee.rocketsolution.provider";
    ...
    protected SQLiteOpenHelper createSqLiteOpenHelper() {
        return RocketSQLiteOpenHelper.getInstance(getContext());
    }
